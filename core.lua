...
LSM:Register("yaui", "tpBorder", mediaFolder.."textures\\UI-Tooltip-Border")
LSM:Register("yaui", "tpBackground", mediaFolder.."textures\\UI-Tooltip-Background")
LSM:Register("yaui", "border2", mediaFolder.."textures\\border")
LSM:Register("yaui", "baricon", mediaFolder.."misc\\icon")
LSM:Register("yaui", "shield", mediaFolder.."textures\\tank")
...
LSM:Register("font", "SansNarrow", mediaFolder.."fonts\\PT_Sans_Narrow.TTF")
LSM:Register("font", "Pixel", mediaFolder.."fonts\\pixel.TTF")
LSM:Register("font", "ActionMan", mediaFolder.."fonts\\Action_Man.TTF")
